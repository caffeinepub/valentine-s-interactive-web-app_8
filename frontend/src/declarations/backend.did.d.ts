...
export interface _SERVICE {
  ...
  'getOrderConfirmation' : ActorMethod<
    [bigint],
    { 'orderId' : bigint, 'confirmationMessage' : string }
  >,
  'getOrderHistorySummary' : ActorMethod<[], Array<Order>>,
  'getOrderStatus' : ActorMethod<[bigint], string>,
  'placeOrder' : ActorMethod<[RequestSummary], bigint>,
}
